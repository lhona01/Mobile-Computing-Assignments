...
potential_states = ["Sunny", "Cloudy", "Rainy", "Windy", "Snowy"]
sequence_of_states = ["Sunny", "Cloudy", "Rainy", "Sunny", "Windy", "Rainy", "Cloudy", "Sunny", "Snowy", "Rainy", "Windy", "Cloudy", "Sunny", "Sunny", "Rainy"]

markov_chain_generator = A1()

apple = markov_chain_generator.generate_markov_chain(potential_states, sequence_of_states)
markov_chain_generator.generate_samples("Sunny", 42, 10)